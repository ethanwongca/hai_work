...
def cross_validate( model_type,
    ...
    for k in range(folds):
        ...
        local_train_confused_path = os.path.join(BASE_DIR, 'dataset_across/augmented_meara/train_cookie_theft/patient/')
        local_val_confused_path = os.path.join(BASE_DIR, 'dataset_across/augmented_meara/val_cookie_theft/patient/')
        local_test_confused_path = os.path.join(BASE_DIR, 'dataset_across/augmented_meara/test_cookie_theft/patient/')
        local_train_not_confused_path = os.path.join(BASE_DIR, 'dataset_across/augmented_meara/train_cookie_theft/control/')
        local_val_not_confused_path = os.path.join(BASE_DIR, 'dataset_across/augmented_meara/val_cookie_theft/control/')
        local_test_not_confused_path = os.path.join(BASE_DIR, 'dataset_across/augmented_meara/test_cookie_theft/control/')
        ...
        trainset = datasets.DatasetFolder(os.path.join(BASE_DIR, 'dataset_across/augmented_meara/train_cookie_theft'),
                                               loader=st_pickle_loader,
                                               extensions='.pkl')

        valset = datasets.DatasetFolder(os.path.join(BASE_DIR, 'dataset_across/augmented_meara/val_cookie_theft'),
                                                 loader=st_pickle_loader,
                                                 extensions='.pkl')

        testset = datasets.DatasetFolder(os.path.join(BASE_DIR, 'dataset_across/augmented_meara/test_cookie_theft'),
                                                 loader=st_pickle_loader,
                                                 extensions='.pkl')
